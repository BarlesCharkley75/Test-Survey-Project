...
import static com.example.quizapp.Creator_Survey_MCQuestionsListActivity.survey_MC_id_list;
import static com.example.quizapp.Creator_TestListActivity.test_id_list;

public class Creator_Survey_CreateMCQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creator__survey__create_m_c_question);
...
//        NumOfTest = intent.getIntExtra("TestNAME", 0);
        ...
        loading = new Dialog(Creator_Survey_CreateMCQuestionActivity.this);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(modifying == false){//means this is a new question
                                    ...
                                    firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    loading.cancel();
                                                    Toast.makeText(Creator_Survey_CreateMCQuestionActivity.this, "succeed", Toast.LENGTH_SHORT).show();
                                                }
                                            });

                                    Intent intent = new Intent(Creator_Survey_CreateMCQuestionActivity.this, Creator_Survey_MCQuestionsListActivity.class);
                    ...
                    firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                            .collection("MCQuestions").document(survey_MC_id_list.get(NumOfQuestion - 1)).update(questionData)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    loading.cancel();
