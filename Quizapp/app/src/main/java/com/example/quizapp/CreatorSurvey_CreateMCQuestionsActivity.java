...
public class CreatorSurvey_CreateMCQuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creatorsurvey__create_m_c_question);
...
//        NumOfSurvey = intent.getIntExtra("SurveyNAME", 0);
        ...
        loading = new Dialog(CreatorSurvey_CreateMCQuestionsActivity.this);
                                    ...
                                    firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    loading.cancel();
                                                    Toast.makeText(CreatorSurvey_CreateMCQuestionsActivity.this, "succeed", Toast.LENGTH_SHORT).show();
                                                }
                                            });

                                    Intent intent = new Intent(CreatorSurvey_CreateMCQuestionsActivity.this, CreatorSurvey_MCQuestionsListActivity.class);
