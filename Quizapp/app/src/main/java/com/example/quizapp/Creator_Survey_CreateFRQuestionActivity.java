...
public class Creator_Survey_CreateFRQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creator__survey__create_f_r_question);
        ...
        loading = new Dialog(Creator_Survey_CreateFRQuestionActivity.this);
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(modifying == false){//means this is a new question
                                    ...
                                    firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    loading.cancel();
                                                    Toast.makeText(Creator_Survey_CreateFRQuestionActivity.this, "succeed", Toast.LENGTH_SHORT).show();
                                                }
                                            });

                                    Intent intent = new Intent(Creator_Survey_CreateFRQuestionActivity.this, Creator_Survey_FRQuestionsListActivity.class);
                    ...
                    firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                            .collection("FRQuestions").document(survey_FR_id_list.get(NumOfQuestion - 1)).update(questionData)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    loading.cancel();
