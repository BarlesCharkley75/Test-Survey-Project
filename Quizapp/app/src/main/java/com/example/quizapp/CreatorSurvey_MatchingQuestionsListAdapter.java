...
import static com.example.quizapp.CreatorSurvey_MatchingQuestionsListActivity.Matching_id_list;
import static com.example.quizapp.Creator_SurveyListActivity.survey_id_list;

public class CreatorSurvey_MatchingQuestionsListAdapter extends BaseAdapter {
    ...
    public CreatorSurvey_MatchingQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), CreatorSurvey_CreateMatchingQuestionActivity.class);
//                intent.putExtra("info",1);
                intent.putExtra("QuestionNAME", position + 1);
//                intent.putExtra("SurveyNAME", NumOfSurvey);
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                        .collection("MatchingQuestions").document("questionList")
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            if(doc.exists()){
                                                ...
                                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                        .collection("MatchingQuestions").document(id)
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        for( int i = 0; i < count; i++){
                                                            if(i != position ){
                                                                quesDoc.put("question"+String.valueOf(index)+"_id",Matching_id_list.get(i));
                                                                index ++;
                                                            }
                                                        }
                                                        ...
                                                        firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), CreatorSurvey_MatchingQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
