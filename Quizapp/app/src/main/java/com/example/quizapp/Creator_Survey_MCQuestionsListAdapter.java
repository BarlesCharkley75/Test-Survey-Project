...
public class Creator_Survey_MCQuestionsListAdapter extends BaseAdapter {
    ...
    public Creator_Survey_MCQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), Creator_Survey_CreateMCQuestionActivity.class);
                                                ...
                                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        for( int i = 0; i < count; i++){
                                                            if(i != position ){
                                                                quesDoc.put("question"+String.valueOf(index)+"_id",survey_MC_id_list.get(i));
                                                                index ++;
                                                            }
                                                        }
                                                        ...
                                                        firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), Creator_Survey_MCQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
