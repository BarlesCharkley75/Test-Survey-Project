...
public class CreatorSurvey_MCQuestionsListAdapter extends BaseAdapter {
    ...
    public CreatorSurvey_MCQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), CreatorSurvey_CreateMCQuestionsActivity.class);
                                                ...
                                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), CreatorSurvey_MCQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
