...
public class Creator_MatchingQuestionsListAdapter extends BaseAdapter {
    ...
    public Creator_MatchingQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), Creator_CreateMatchingQuestionActivity.class);
                                                ...
                                                firestore.collection("tests").document(test_id_list.get(CurrentNumOfTest))
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        firestore.collection("tests").document(test_id_list.get(CurrentNumOfTest))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), Creator_MatchingQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
