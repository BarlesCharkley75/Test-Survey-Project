...
public class Creator_CreateRankingQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = new Dialog(Creator_CreateRankingQuestionActivity.this);
                    ...
                    firestore.collection("tests").document(test_id_list.get(CurrentNumOfTest))
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Intent intent = new Intent(Creator_CreateRankingQuestionActivity.this, Creator_RankingQuestionsListActivity.class);
