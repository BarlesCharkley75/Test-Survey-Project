...
public class Creator_Survey_RankingQuestionsListAdapter extends BaseAdapter {
    ...
    public Creator_Survey_RankingQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), Creator_Survey_CreateRankingQuestionActivity.class);
                                                ...
                                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        for( int i = 0; i < count; i++){
                                                            if(i != position ){
                                                                quesDoc.put("question"+String.valueOf(index)+"_id",survey_Ranking_id_list.get(i));
                                                                index ++;
                                                            }
                                                        }
                                                        ...
                                                        firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), Creator_Survey_RankingQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
