...
public class Creator_Survey_RankingQuestionsListActivity extends AppCompatActivity {

    private GridView survey_RankingQuestion_List;
    ...
    public static ArrayList<String> survey_Ranking_id_list = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_creator__survey__ranking_questions_list);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("survey"+String.valueOf(CurrentNumOfSurvey + 1)+": " + "List of Ranking questions");

        survey_RankingQuestion_List = findViewById(R.id.creator_survey_RankingQuestions_list_gridview);
        add_new_question = findViewById(R.id.AddQuestionButton);

        firestore = FirebaseFirestore.getInstance();

        loading = new Dialog(Creator_Survey_RankingQuestionsListActivity.this);
        ...
        add_new_question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent (Creator_Survey_RankingQuestionsListActivity.this, Creator_Survey_CreateRankingQuestionActivity.class);
...
//                            String testName = doc.getString("test" + String.valueOf(i)+"_name");
                                    ...
                                    survey_Ranking_id_list.add(doc.getString("question" + String.valueOf(i)+"_id"));

                                }

                                //Refer to TestListActivity to see how to set up the grid view adapter.
                                Creator_Survey_RankingQuestionsListAdapter adapter = new Creator_Survey_RankingQuestionsListAdapter(sub_RankingQuestionsList);
                                survey_RankingQuestion_List.setAdapter(adapter);

                                loading.cancel();
                            }
                            else{
                                loading.cancel();
                                Toast.makeText(Creator_Survey_RankingQuestionsListActivity.this, "No question yet",Toast.LENGTH_SHORT).show();
                                Creator_Survey_RankingQuestionsListAdapter adapter = new Creator_Survey_RankingQuestionsListAdapter(sub_RankingQuestionsList);
                                survey_RankingQuestion_List.setAdapter(adapter);
                            }
                        }
                            ...
                            loading.cancel();
                            Toast.makeText(Creator_Survey_RankingQuestionsListActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
