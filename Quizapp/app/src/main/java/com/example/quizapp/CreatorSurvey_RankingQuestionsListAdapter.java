...
public class CreatorSurvey_RankingQuestionsListAdapter extends BaseAdapter {
    ...
    public CreatorSurvey_RankingQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), CreatorSurvey_CreateRankingQuestionActivity.class);
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                        .collection("RankingQuestions").document("questionList")
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            if(doc.exists()){
                                                ...
                                                firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                        .collection("RankingQuestions").document(id)
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        for( int i = 0; i < count; i++){
                                                            if(i != position ){
                                                                quesDoc.put("question"+String.valueOf(index)+"_id",Ranking_id_list.get(i));
                                                                index ++;
                                                            }
                                                        }
                                                        ...
                                                        firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), CreatorSurvey_RankingQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
