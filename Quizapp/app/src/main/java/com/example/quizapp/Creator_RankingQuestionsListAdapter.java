...
public class Creator_RankingQuestionsListAdapter extends BaseAdapter {
    ...
    public Creator_RankingQuestionsListAdapter(ArrayList<String> questionList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( parent.getContext(), Creator_CreateRankingQuestionActivity.class);
                                                ...
                                                firestore.collection("tests").document(test_id_list.get(CurrentNumOfTest))
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        firestore.collection("tests").document(test_id_list.get(CurrentNumOfTest))
                                                            ...
                                                            @Override
                                                            public void onSuccess(Void aVoid) {
                                                                Intent intent = new Intent (parent.getContext(), Creator_RankingQuestionsListActivity.class);
                                                                parent.getContext().startActivity(intent);
                                                            }
                                                        });
