...
public class CreatorSurvey_CreateMatchingQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creatorsurvey__create_matching_question);
        ...
        loading = new Dialog(CreatorSurvey_CreateMatchingQuestionActivity.this);
                                    ...
                                    firestore.collection("surveys").document(survey_id_list.get(CurrentNumOfSurvey))
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    loading.cancel();
                                                    Toast.makeText(CreatorSurvey_CreateMatchingQuestionActivity.this, "succeed", Toast.LENGTH_SHORT).show();
                                                }
                                            });

                                    Intent intent = new Intent(CreatorSurvey_CreateMatchingQuestionActivity.this, CreatorSurvey_MatchingQuestionsListActivity.class);
