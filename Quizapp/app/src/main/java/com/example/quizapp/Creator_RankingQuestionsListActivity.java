...
public class Creator_RankingQuestionsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creator__ranking_questions_list);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("test"+String.valueOf(CurrentNumOfTest + 1)+": " + "List of Ranking questions");

        RankingQuestion_List = findViewById(R.id.creator_RankingQuestions_list_gridview);
        add_new_question = findViewById(R.id.AddQuestionButton);

        firestore = FirebaseFirestore.getInstance();

        loading = new Dialog(Creator_RankingQuestionsListActivity.this);
        ...
        add_new_question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent (Creator_RankingQuestionsListActivity.this, Creator_CreateRankingQuestionActivity.class);
    ...
    private void loadData(){
        ...
        firestore.collection("tests").document(test_id_list.get(CurrentNumOfTest)).collection("RankingQuestions")
...
//                            String testName = doc.getString("test" + String.valueOf(i)+"_name");
                                    ...
                                    sub_RankingQuestionsList.add(testName);
                                ...
                                Creator_RankingQuestionsListAdapter adapter = new Creator_RankingQuestionsListAdapter(sub_RankingQuestionsList);
                                ...
                                loading.cancel();
                                Toast.makeText(Creator_RankingQuestionsListActivity.this, "No question yet",Toast.LENGTH_SHORT).show();
                                Creator_RankingQuestionsListAdapter adapter = new Creator_RankingQuestionsListAdapter(sub_RankingQuestionsList);
                                RankingQuestion_List.setAdapter(adapter);
                            }
                        }
                            ...
                            loading.cancel();
                            Toast.makeText(Creator_RankingQuestionsListActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
